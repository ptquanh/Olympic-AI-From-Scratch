...
**Files:** README.md, lab.ipynb, code_notes.md, exercises.md, references.md
...
> **CHỈ dùng thư viện ĐƯỢC PHÉP TRONG THI** (Cẩm nang Phần 08). Không dạy thư viện ngoài danh sách.
