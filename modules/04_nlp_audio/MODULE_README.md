...
> **Ánh xạ Cẩm nang:** Chặng 3-4 — "Xử lý ngôn ngữ tự nhiên" & "Audio"

Nắm vững cách máy tính hiểu văn bản và âm thanh, từ tiền xử lý (Tokenizer, Waveform) đến các mô hình học sâu hiện đại nhất như Transformer (Attention) và ứng dụng mạnh mẽ của Pre-trained Models (Họ nhà BERT).
