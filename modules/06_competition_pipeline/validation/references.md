# References: Validation — Đo đúng khả năng tổng quát hóa

## 📚 Official Documentation

| Thư viện/chủ dự án | Đọc gì                                              | Link trực tiếp                                                                                                    |
| ------------------ | --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| Tách group         | `GroupKFold(n_splits=3)`                            | [Trang trực tiếp](https://scikit-learn.org/stable/modules/generated/sklearn.model_selection.GroupKFold.html)      |
| Giữ tỷ lệ nhãn     | `StratifiedKFold(3, shuffle=True, random_state=42)` | [Trang trực tiếp](https://scikit-learn.org/stable/modules/generated/sklearn.model_selection.StratifiedKFold.html) |
| Tách thời gian     | `TimeSeriesSplit(n_splits=3, gap=1)`                | [Trang trực tiếp](https://scikit-learn.org/stable/modules/generated/sklearn.model_selection.TimeSeriesSplit.html) |
...
| ------------------------------------------------------------------- | ---------------------------------------------- | ------------------------------------------------------ |
| HOML, 3rd ed.                                                       | Ch.2 — Create a Test Set / Evaluate Your Model | Tách model selection khỏi đánh giá cuối.               |
...
- [Bài đọc trực tiếp](https://scikit-learn.org/stable/modules/cross_validation.html) — đối chiếu quy trình và các failure mode được dùng trong chương; đây là nguồn của phương pháp, không phải nguồn dataset của lab.
